  ...
  return (
    <div className="bg-white min-h-screen text-black selection:bg-black selection:text-white">
        ...
        <div className="px-4 md:px-6 py-6 max-w-7xl mx-auto flex flex-col md:flex-row md:items-end justify-between gap-4">
          <div>
            ...
            <p className="text-gray-400 mt-2 uppercase text-[9px] md:text-[10px] tracking-[0.3em] font-bold">
              Explore our full range of performance gear
            </p>
          </div>
      ...
      <main className="max-w-7xl mx-auto px-4 md:px-6 py-8 md:py-12">
        {/* Product Grid - Exactly the same scheme as Home */}
            ...
            >
              ...
              <div className="aspect-[4/5] bg-[#f6f6f6] overflow-hidden relative">            
                ...
                <div className="absolute inset-x-0 bottom-0 p-2 md:p-4 translate-y-full group-hover:translate-y-0 transition-transform duration-300 ease-in-out bg-gradient-to-t from-black/20 to-transparent hidden md:block">
                  <div className="bg-black hover:text-black hover:bg-white text-white py-2 md:py-3 text-center text-[10px] md:text-xs font-bold uppercase tracking-widest opacity-0 group-hover:opacity-100 transition-opacity">
                   QUICK LOOK
                  </div>
                </div>
              </div>
                ...
                <div className="mt-auto">
                  <div className="flex justify-between items-center flex-wrap gap-1 mb-4">
                    <div className="flex flex-wrap gap-1">
                      {p.sizes.map((s, i) => (
                        <span
                          key={i}
                          className="text-[8px] md:text-[10px] font-bold border border-gray-200 px-1.5 py-0.5 text-gray-400 uppercase"
                        >
                          {s}
                        </span>
                      ))}
                    ...
                    <div className="flex flex-wrap gap-1">
                      {p.category.map((cat, i) => (
                        <span
                          key={i}
                          className="text-[8px] md:text-[10px] font-bold border border-gray-400 px-1.5 py-0.5 text-gray-400 uppercase"
                        >
                          {cat}
                        </span>
                      ))}
                  ...
                  <div className="pt-4 border-t border-gray-100 flex flex-col gap-4">
                    ...
                    <a
                      ...
                      onClick={(e) => e.stopPropagation()} // Prevents navigation to product page when clicking buy now
                      className="w-full bg-black hover:text-black hover:bg-white text-center text-white py-3 md:py-4 text-[10px] md:text-xs font-bold uppercase tracking-[0.2em] transition-all duration-300 hover:bg-gray-800 active:scale-[0.98] shadow-lg shadow-black/5"
                    >
                      Buy Now
                    </a>
                  </div>
